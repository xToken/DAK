...
LoadFromServerLUA to true.  You will also want to make sure that you place the Script.Load("lua/DAKLoader.lua") before the load statement for ServerConfig.  It
